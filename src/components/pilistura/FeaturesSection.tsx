...
export default function FeaturesSection({ stepsImage }) {
  return (
    <section className="relative py-16 sm:py-20 md:py-36 bg-background overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-16 lg:px-24">
          ...
          {FEATURES.map((feat, i) => {
            ...
            return (
              <motion.div
                ...
                className="group p-5 sm:p-8 border border-border hover:border-accent/30 transition-all duration-500"
              >
        ...
        >
            <div className="relative w-full h-44 sm:h-48 md:h-72 overflow-hidden">
            <img
              src={stepsImage}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <p className="font-heading font-bold text-2xl sm:text-3xl md:text-5xl text-white uppercase text-center drop-shadow-lg">
